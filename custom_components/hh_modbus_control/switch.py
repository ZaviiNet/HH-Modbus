...
from custom_components.hh_modbus_control.const import DOMAIN, ENTITIES, SWITCH_ENTITIES
from custom_components.hh_modbus_control.helpers import get_controller_from_entry
from custom_components.hh_modbus_control.sensor_data.switch_sensors import get_switch_sensors
from custom_components.hh_modbus_control.sensors.solis_binary_sensor import SolisBinaryEntity
