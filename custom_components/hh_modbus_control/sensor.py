...
from custom_components.hh_modbus_control.const import DOMAIN, SENSOR_DERIVED_ENTITIES, SENSOR_ENTITIES, VALUES
...
from custom_components.hh_modbus_control.sensors.solis_sensor import SolisSensor
